...
namespace MISA.WebFresher2023.Demo.Common.Resource
{
    ...
    public static class EmployeeUserMessage
    {
        ...
        public static readonly string CantDeleteEmployeeInCustomer = "Không thể xóa nhân viên có liên quan đến khách hàng";

        public static readonly string CantDeleteEmployeeInReceipt = "Không thể xóa nhân viên có liên quan đến phiếu thu";
    }
